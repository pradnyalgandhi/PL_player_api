...
urlpatterns = [
    ...
    path('player_attacking_stats/', PlayerAttackingStatsList.as_view(), name="player-attacking_stat"),
    path('player_defensive_stats/', PlayerDefensiveStatsList.as_view(), name="player-defensive-stat"),
